...
<html lang="es">
                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Ambulancia ET-719</h3> <ol class="breadcrumb">
                            <li><a href="index.php">Inicio</a></li>
                            <li><a href="ambulancias.php">Ambulancias</a></li>
                            <li class="active">ET-719</li>
                            </ol>
                        </div>
                            ...
                            <div class="col-xs-2 pull-right">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="et_719_niveles.php">Niveles</a></li>
                                    </ul>
                                </div>
    ...
    <script> //TODO borrar
        function añadirRegistro(){
            ...
            var ref = database.ref("ambulancias").child("et_719").child("niveles");
            var data = {
    ...
    <script>
        ...
        function getTablaTotal(){
            var database = firebase.database();
            var ref = database.ref("ambulancias/et_719/existe");
            ...
            $table.on('editable-save.bs.table', function(field, row, oldValue, $el){
                ...
                if (cantidad_previa != nueva_cantidad){
                    var ref2 = database.ref("ambulancias/et_719/niveles/" + oldValue.clave_nivel);
        ...
        function getRevisiones(){
            var ref = firebase.database().ref('ambulancias/et_719/revisiones_electromedicina').orderByKey().limitToLast(10);
        ...
        function getRevisiones1(){
            var database = firebase.database();
            var ref = database.ref("ambulancias/et_719/revisiones_electromedicina");
        ...
        function getArrayLocalizaciones(){
            var ref = firebase.database().ref('ambulancias/et_719/localizaciones');
        ...
        function getTablaNivel(){
            ...
            var ref = firebase.database().ref('ambulancias/et_719/niveles/');
        ...
        function debug001(){
            ...
            ref.once("value", function(data) {
                data.forEach(function (childSnap){
                    firebase.database().ref("ambulancias/et_719/niveles/" + childSnap.key).update({
                        "existe": 0
                    });
                });
            });
            ...
            <div class="modal-content">
                ...
                <script>
                    $('#button-añadir-registro').on('click', function () {
                        ...
                        var ref_nivel = firebase.database().ref("ambulancias/et_719/niveles");
                        ...
                        ref_nivel.once("value", function(data) {
                            ...
                            var ref = firebase.database().ref("ambulancias/et_719/existe/");
                            ref.push(data);
                            ...
                            firebase.database().ref("ambulancias/et_719/niveles/" + var_clave_nivel).update({
                                "existe": var_existe
                            });
                ...
                <div class="modal-footer">
                    ...
                    <script>
                        $('#button-añadir-revision-electromedicina').on('click', function () {
                            ...
                            var ref = firebase.database().ref("ambulancias/et_719/revisiones_electromedicina/");
                            ref.push(data);
                            new PNotify({
                                title: 'Añadido',
        ...
        <script>
            $('#ModalEliminar').on('show.bs.modal', function (event) {
                ...
                $('#button-eliminar').on('click', function () {
                    ...
                    var ref2 = firebase.database().ref("ambulancias/et_719/niveles/" + clave_nivel);
